...
SHEET_USERS_NAME = os.getenv("SHEET_USERS_NAME")

sheety_endpoint = f"https://api.sheety.co/{USERNAME_SHEETY}/{PROJECT_NAME}/{SHEET_NAME}"
sheety_users_endpoint = f"https://api.sheety.co/{USERNAME_SHEETY}/{PROJECT_NAME}/{SHEET_USERS_NAME}"
...
class DataManager:
    ...
    def get_customer_emails(self):
        sheet_response = requests.get(sheety_users_endpoint, headers=self.headers)
        sheet_data = sheet_response.json()
        self.users_data = sheet_data['users']
